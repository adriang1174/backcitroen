...
?>
 ...
 <script src="http://www.pengoworks.com/workshop/jquery/lib/jquery.autocomplete.js"></script>  
...
<script>
	      ...
	      $.get('<?php echo URL_ROOT ."admin/ajax/get_eventos.php"?>', function(data){ // grab content from another page
            var obj = JSON.parse(data);
		  $( "#evento" ).autocompleteArray(obj.data); 
